...
public class StartingPoint extends Applet implements Runnable, KeyListener, MouseMotionListener, MouseListener {
	...
	public void paint(Graphics g) {
		...
		if (gameOver) {
			...
			g.setColor(Color.BLACK);
			g.drawString("great game applet", 10, 630);
			...
			g.drawString("enjoy it? me to.", 10, 600);
			g.setColor(Color.GREEN);
			g.drawString("A Product by Yaacov Nathan", 10, 50);
			g.setColor(Color.black);
			g.drawString("Yaacovisraelnathan@gmail.com", 10, 90);
